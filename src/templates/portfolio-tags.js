...
import PortfolioHero from '../pages/portfolio/hero'
import PortfolioFilter from '../pages/portfolio/filter'
class PortfolioTagRoute extends React.Component {
  render() {
...
export default PortfolioTagRoute

export const tagPageQuery = graphql`
  query PortfolioTagPage($tag: String) {
    site {
      siteMetadata {
        title
      }
