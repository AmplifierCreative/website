          ...
          <div className='columns is-vcentered is-mobile'>
            ...
            <div className='column is-relative'>
              <div className='burger-container'>
                ...
                >
                  <span
                    className={`burger-line-top ${this.state.navBarActiveClass}`}
                  />
                  <span
                    className={`burger-line middle ${this.state.navBarActiveClass}`}
                  />
                  <span
                    className={`burger-line bottom ${this.state.navBarActiveClass}`}
                  />
                </div>
              </div>
              <div className='navbar-menu-container'>
                <ul
                  className={`menu-list has-text-right ${this.state.navBarActiveClass}`}
                >
                  <Menu
                    native
                    items={items}
